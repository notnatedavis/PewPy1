...
import cv2
import dxcam
from pewpy.utils.color import opencv_hsv_to_user, user_hsv_to_rgb_hex
...
class DebugWindow(ctk.CTkToplevel):
    ...
    def _populate_colors(self, color_list):
        ...
        for h_deg, s_pct, v_pct in color_list:
            ...
            # Convert HSV to RGB for preview using utility
    ...
    def _refresh_avoid_tab(self):
        ...
        for idx, ((low_h, low_s, low_v), (high_h, high_s, high_v)) in enumerate(avoid_list):
            ...
            # Compute the centre of the stored range (already in user-friendly HSV)
            ...
            # Label shows the centre values directly (no extra conversion)
